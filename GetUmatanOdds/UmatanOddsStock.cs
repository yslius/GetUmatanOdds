...
namespace GetUmatanOdds
{
    public class UmatanOddsStock
    {
        ...
        public UmatanOddsStock(clsCommon cCommon1, Form1 form1)
        {
            ...
            //List<clcUmatanOdds> listUmatanOddsH1 = new List<clcUmatanOdds>();
            //List<clcRaceUma> listUmatanOddsO1 = new List<clcRaceUma>();
            //List<clcUmatanOdds> listUmatanOdds = new List<clcUmatanOdds>();
            //List<clcOddsSanrentan> listOddsSanrentan = new List<clcOddsSanrentan>();
        }
